package com.foysaltech.PrayerTimes.services;
...
{
    public static final String EXTRA_PRAYER = "com.foysaltech.PrayerTimes.PRAYER";
    public static final String EXTRA_MUEZZIN = "com.foysaltech.PrayerTimes.MUEZZIN";
    public static final int ATHAN_DURATION= 6 * 60 * 1000;          // longest audio is 5' 10''

    public static final String ACTION_NOTIFY_ATHAN = "com.foysaltech.PrayerTimes.action.NOTIFY_ATHAN";
    public static final String ACTION_PLAY_ATHAN = "com.foysaltech.PrayerTimes.action.PLAY_ATHAN";
    public static final String ACTION_STOP_ATHAN = "com.foysaltech.PrayerTimes.action.STOP_ATHAN";
    ...
    private Notification buildNotification() {
        ...
        mNotificationBuilder = new NotificationCompat.Builder(this, channelId)
                ...
                .setSmallIcon(R.drawable.ic_notif_large)
